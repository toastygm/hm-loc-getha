...
template.url = "https://github.com/toastygm/hm-loc-getha";
template.bugs = "https://github.com/toastygm/hm-loc-getha/issues";
template.manifest =
    "https://github.com/toastygm/hm-loc-getha/releases/latest/download/module.json";
template.download = `https://github.com/toastygm/hm-loc-getha/releases/download/v${pkg.version}/module.zip`;
